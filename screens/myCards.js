    ...
    return (
        <SafeAreaView>
            ...
            >
                ...
                <Pressable style={({ pressed }) => [styles.savedCards, pressed && { opacity: 0.7 }]} onPress={() => { navigation.navigate("savedCards") }}>
                    <Text style={[styles.cardText, { fontSize: 12 }]}>Saved Cards</Text>
                </Pressable>
            </Animatable.View>
