        ...
        if (loading) {
            return (
                <View style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: width * 0.3 }}>
                    ...
                    <Text style={styles.searching}>Hold on while we are generating feed for you!</Text>
                </View>
            )
        }
        else {
                ...
                <SafeAreaView>
                    ...
                    >
                        {result.map((item, index) => {
                            ...
                            return <Card2 item={item} opacity={opacity} navigation={navigation} index={index} key={index} />
                        })}
                    </Animated.ScrollView>
                </SafeAreaView >
            )
